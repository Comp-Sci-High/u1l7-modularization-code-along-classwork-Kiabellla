...
console.log(heroAction("iron Man", "jarvis and his suit", "new york"))
console.log(heroAction("the falcon", "his wings", "washington dc"))
...
// Step 4: Add
//  the function logic to return the full statement. 
function villianAction(villian, location, chaos) {
    return villian + " has escaped from the left Raft and is causing chaos in " + location + " by " + chaos + "!"
}

// Step 5: Call the function below for Doctor Octopus, Electro, Vulture, Sandman, Mysterio, & Kraven the Hunter
console.log(villianAction("Doctor Octopus", "Times Square", "destroying cars with his mechanical arms"))
console.log(villianAction("Electro", "Central Park", "overloading the city's power grid"))
console.log(villianAction("Vulture", "Empire State Building", "swooping down and grabbing people off the streets"))
console.log(villianAction("Sandman", "Brooklyn Bridge", "turning the bridge into sand"))
console.log(villianAction("Mysterio", "Broadway", "casting illusions to confuse and panic everyone"))
...
console.log(villianAction("Kraven the Hunter", "The Bronx Zoo", "releasing and hunting wild animals"))
